...
input0 = InferInput('input_ids', input_ids.shape, 'INT64')
input1 = InferInput('attention_mask', attention_mask.shape, 'INT64')
input2 = InferInput('token_type_ids', token_type_ids.shape, 'INT64')
...
plt.xlabel('Latency')
plt.ylabel('Density')
plt.savefig('single/pt/outcome/PREPROCESS_KDE.png')
plt.close() 
...
plt.ylabel('CDF')
plt.grid(True)
plt.savefig('single/pt/outcome/PREPROCESS_CDF.png')
plt.close()
...
plt.ylabel('Density')
plt.savefig('single/pt/outcome/INFERENCE_KDE.png')
plt.close() 
...
plt.grid(True)
plt.savefig('single/pt/outcome/INFERENCE_CDF.png')
plt.close()
