...
try:
    ...
    with open('plot/single/single_runtime.json', 'w') as file:
    ...
    ax.grid(True)
    ax.set_ylim(0, 100)
    plt.savefig(f"single/trt/outcome/GPU_UTIL.png")
    
    with open('plot/single/gpu_util_single.json', 'w') as file:
    ...
    ax.grid(True)
    ax.set_ylim(0, 100)
    plt.savefig(f"single/trt/outcome/GPUMEM_UTIL.png")
    ...
    ax.grid(True)
    ax.set_ylim(0, 100)
    plt.savefig(f"single/trt/outcome/CPU_UTIL.png")
    
    with open('plot/single/cpu_util_single.json', 'w') as file:
    ...
    ax.grid(True)
    ax.set_ylim(0, 100)
    plt.savefig(f"single/trt/outcome/CPUMEM_UTIL.png")
