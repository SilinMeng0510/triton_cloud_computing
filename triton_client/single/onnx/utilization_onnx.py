...
try:
    ...
    ax.grid(True)
    ax.set_ylim(0, 100)
    plt.savefig(f"single/onnx/outcome/GPU_UTIL.png")
    ...
    ax.grid(True)
    ax.set_ylim(0, 100)
    plt.savefig(f"single/onnx/outcome/GPUMEM_UTIL.png")
    ...
    ax.grid(True)
    ax.set_ylim(0, 100)
    plt.savefig(f"single/onnx/outcome/CPU_UTIL.png")
    ...
    ax.grid(True)
    ax.set_ylim(0, 100)
    plt.savefig(f"single/onnx/outcome/CPUMEM_UTIL.png")
