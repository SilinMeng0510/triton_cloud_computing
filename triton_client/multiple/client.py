...
with open('plot/multiple/preprocess_latency_multiple.json', 'w') as file:
    json.dump(record_preprocess_latency, file)
    
with open('plot/multiple/inference_latency_multiple.json', 'w') as file:
...
with open('plot/multiple/preprocess_P_multiple.json', 'w') as file:
...
plt.xlabel('Latency')
plt.ylabel('Density')
plt.savefig('multiple/outcome/PREPROCESS_KDE.png')
plt.close() 
...
plt.ylabel('CDF')
plt.grid(True)
plt.savefig('multiple/outcome/PREPROCESS_CDF.png')
plt.close()
...
with open('plot/multiple/inference_P_multiple.json', 'w') as file:
...
plt.ylabel('Density')
plt.savefig('multiple/outcome/INFERENCE_KDE.png')
plt.close() 
...
plt.grid(True)
plt.savefig('multiple/outcome/INFERENCE_CDF.png')
plt.close()
